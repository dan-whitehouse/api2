 ...
 */
public class AcademicSessionChildComposite implements Serializable {
    private static final long serialVersionUID = -6727456278122460145L;

    private String childId;
    private Integer childSchoolYear;

    public AcademicSessionChildComposite() {
    }

    public AcademicSessionChildComposite(String childId, Integer childSchoolYear) {
    ...
    public boolean equals(Object o) {
        ...
        if(!(o instanceof AcademicSessionChildComposite)) return false;

        AcademicSessionChildComposite that = (AcademicSessionChildComposite) o;
