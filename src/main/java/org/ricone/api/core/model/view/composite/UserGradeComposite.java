 ...
 */
public class UserGradeComposite implements Serializable {
    private static final long serialVersionUID = -6727456278122460145L;

    private String gradeId;
    private Integer gradeSchoolYear;

    public UserGradeComposite() {
    }

    public UserGradeComposite(String gradeId, Integer gradeSchoolYear) {
    ...
    public boolean equals(Object o) {
        ...
        if(!(o instanceof UserGradeComposite)) return false;

        UserGradeComposite that = (UserGradeComposite) o;
