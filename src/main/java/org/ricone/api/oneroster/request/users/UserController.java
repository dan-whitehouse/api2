...
@RestController("OneRoster2:Users:UserController")
@Api(value = "User", description = "One Roster - Users", tags = {"User"})
public class UserController extends BaseController {
	@Autowired
	private UserService service;

	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/users/{id}")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/users")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/students/{id}")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/students")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/schools/{id}/students")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/classes/{id}/students")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/schools/{schoolId}/classes/{classId}/students")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/teachers/{id}")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/teachers")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/schools/{id}/teachers")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/classes/{id}/teachers")
	...
	@ResponseBody @GetMapping(value = "/ims/oneroster2/v1p1/schools/{schoolId}/classes/{classId}/teachers")
