CREATE VIEW UserView_GroupConcat AS
(
	select
        ...
        (
			...
			where sub_se.StudentEnrollmentRefId = se.StudentEnrollmentRefId
			and sub_se.StudentEnrollmentSchoolYear = se.StudentEnrollmentSchoolYear
			group by sub_se.StudentEnrollmentRefId
		) as Grades
	from Student as s
