 ...
 */
public class GradeComposite implements Serializable {
    private static final long serialVersionUID = -6727456278122460145L;

    private String gradeId;
    private Integer gradeSchoolYear;

    public GradeComposite() {
    }

    public GradeComposite(String gradeId, Integer gradeSchoolYear) {
    ...
    public boolean equals(Object o) {
        ...
        if(!(o instanceof GradeComposite)) return false;

        GradeComposite that = (GradeComposite) o;
